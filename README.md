...
- A <style>Python {color:Blue;}</style> script, developed in <b>Jupyter Notebooks</b>, interacts with the GitHub Rest API to gather repository data in JSON format.  The script handles the default pagination of the API, and nested for loops are used to iterate through 2 repositories and 4 endpoints.
